...
const translations: Translations = {
  ...
  'לינוי בנימיני': { he: 'לינוי בנימיני', en: 'Linoy Benyamini' },
      'עוזרת אישית למנכ"ל - קבוצת BST, מנכ"ל תפעול - קרן אווה ובדיע טנוס (ז"ל)': {
      he: 'עוזרת אישית למנכ"ל - קבוצת BST, מנכ"ל תפעול - קרן אווה ובדיע טנוס (ז"ל)',
      en: 'PA to CEO - BST Group, COO - Eva & Badi Tannous Foundation (RIP)'
    },
