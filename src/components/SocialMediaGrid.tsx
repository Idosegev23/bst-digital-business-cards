...
import { Mail, Phone, Building, Youtube, Globe, Linkedin, Instagram, Facebook } from 'lucide-react'
...
export default function SocialMediaGrid({ employee }: SocialMediaGridProps) {
  return (
    <div className="social-media-grid">
      <a href={`https://wa.me/${employee.whatsapp?.replace(/[^0-9]/g, '')}`} className="social-icon glass-icon">
      ...
      <a href={`tel:${employee.phone}`} className="social-icon glass-icon">
        <Phone size={28} />
      </a>
      
      <a href={`tel:${employee.office || employee.phone}`} className="social-icon glass-icon">
        <Building size={28} />
      </a>
      
      <a href={employee.socialMedia.youtube || "#"} className="social-icon glass-icon">
        <Youtube size={28} />
      </a>
